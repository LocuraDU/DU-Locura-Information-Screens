...
local version=1.2 -- Script Version
...
renderRow("Chromium","T2","44","4500","4860","75","YES","NO",green,yellow,yellow,yellow,red,red)
renderRow("Cobalt","T4","29","4500","6998","75","YES","NO",yellow,yellow,yellow,yellow,red,red)
renderRow("Copper","T2","44","6000","6480","100","YES","NO",green,green,yellow,red,red,red)
renderRow("Flourine","T4","29","1500","2333","25","YES","NO",yellow,red,red,green,red,red)
renderRow("Gold","T4","44","6000","9331","100","YES","NO",green,green,green,red,red,red)
renderRow("Iron","T1","44","6000","5400","100","NO","SOME",green,green,yellow,red,green,yellow)
renderRow("Lithium","T3","29","1500","1944","25","YES","NO",yellow,red,red,green,red,red)
renderRow("Manganese","T5","29","4500","8398","75","YES","NO",yellow,yellow,green,yellow,red,red)
renderRow("Nickle","T3","29","4500","5832","75","YES","NO",yellow,yellow,yellow,yellow,red,red)
renderRow("Niobium","T5","29","6000","11197","100","YES","NO",yellow,green,green,red,red,red)
renderRow("Scandium","T4","29","3000","4666","50","YES","NO",yellow,yellow,yellow,yellow,red,red)
renderRow("Silicon","T1","29","4500","4050","75","NO","SOME",yellow,yellow,yellow,yellow,green,yellow)
renderRow("Silver","T3","29","6000","7776","100","YES","NO",yellow,green,green,red,red,red)
renderRow("Sodium","T2","29","4500","1620","25","YES","NO",yellow,red,red,green,red,red)
renderRow("Sulfer","T3","29","3000","3888","50","YES","NO",yellow,yellow,red,yellow,red,red)
renderRow("Titanium","T5","44","1500","2799","25","YES","NO",green,red,red,green,red,red)
...
renderRow("Concrete","T1","15","720","756","12","YES","NO",red,red,red,green,red,red)
renderRow("Duralumin","T2","29","2400","3528","40","YES","NO",yellow,yellow,red,yellow,red,red)
renderRow("G5 Titanium","T5","29","2400","9681","40","YES","NO",yellow,yellow,green,yellow,red,red)
renderRow("Inconel","T3","29","3600","7409","60","YES","NO",yellow,yellow,green,yellow,red,red)
renderRow("Luminescent","T1","11","120","126","2","YES","NO",red,red,red,green,red,red)
renderRow("Mangalloy","T5","29","3600","14521","60","YES","NO",yellow,yellow,green,yellow,red,red)
renderRow("Maraging","T4","29","3600","10372","60","YES","NO",yellow,yellow,green,yellow,red,red)
renderRow("Marble","T1","69","600","630","10","YES","NO",green,red,red,green,red,red)
renderRow("Plastic","T1","141","1200","1260","20","YES","SOME",green,red,red,green,red,yellow)
renderRow("SC-AL","T4","29","2400","6915","40","YES","NO",yellow,red,yellow,yellow,red,red)
renderRow("Silumin","T1","29","2400","2520","40","YES","SOME",yellow,red,red,yellow,red,yellow)
renderRow("Stainless Steel","T2","29","3600","5292","60","YES","NO",yellow,yellow,red,yellow,red,red)
renderRow("Steel","T1","99","3600","3780","60","YES","SOME",green,yellow,red,yellow,red,yellow)
renderRow("Wood","T1","51","360","378","6","YES","SOME",green,red,red,green,red,yellow)
end
